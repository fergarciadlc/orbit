...
void OutputGUI::resized()
{
    ...
    mixtLabel  .setBoundsRelative(0.5f - diameter / 2, 0.33f - diameter / 2, diameter, diameter);
    outputLabel.setBoundsRelative(0.5f - diameter / 2, 0.66f - diameter / 2, diameter, diameter);
}
